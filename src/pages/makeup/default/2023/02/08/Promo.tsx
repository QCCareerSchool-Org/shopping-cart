    ...
    <>
      <section id="promoSection" style={{ backgroundColor, padding: 0 }}>
        ...
        <Modal size="lg" isOpen={popup} toggle={togglePopup}>
          ...
          <ModalBody>
            <p className="lead">Treat yourself this Valentine&apos;s Day with the Pro Makeup Workshop FREE! Plus, the Luminous Collection.</p>
            <p>Enroll and get the Pro Makeup Workshop FREE! Plus, the Luminous Collection!</p>
