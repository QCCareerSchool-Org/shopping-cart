...
export const MakeupPromo20230406 = (): ReactElement => {
    ...
    <>
      <section id="promoSection" style={{ backgroundColor, padding: 0 }}>
        ...
        <Modal isOpen={popup} toggle={togglePopup}>
          ...
          <ModalBody>
            <p>Enroll in Master Makeup Artistry and get the Skincare Consultant course FREE. Plus, we&apos;ll also send you the ENTIRE Luminous Collection!</p>
      ...
      <CountDownTimerWrapper
        ...
        message={<span style={{ textTransform: 'uppercase' }}><strong>Last chance!</strong> Get the Skincare Consultant course FREE!</span>}
      />
    </>
  );
};
