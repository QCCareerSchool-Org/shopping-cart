...
export const MakeupPromo20230505 = (): ReactElement => {
    ...
    <>
      <section id="promoSection" style={{ backgroundColor, padding: 0 }}>
        ...
        <Modal isOpen={popup} toggle={togglePopup}>
          ...
          <ModalBody>
            <p>Enroll in <strong>Master Makeup Artistry</strong> &amp; get the <strong>Global Beauty Workshop</strong> free. When you pay in full, you&apos;ll also receive the entire DELUXE Collection!</p>
