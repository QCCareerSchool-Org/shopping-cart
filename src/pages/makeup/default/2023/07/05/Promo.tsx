...
export const MakeupPromo20230705 = (): ReactElement => {
      ...
      <section id="promoSection" style={{ backgroundColor, padding: 0 }}>
        ...
        <Modal isOpen={popup} toggle={togglePopup}>
          ...
          <ModalBody>
            ...
            <p>Enroll in Master Makeup Artistry and get the <strong>Skincare Course FREE</strong>.</p>
