...
const lastChanceDate = new Date(Date.UTC(2023, 9, 27, 4)); // October 27 at 00:00 (04:00 UTC)
const timerShowDate = new Date(Date.UTC(2023, 9, 27, 4)); // October 27 at 00:00 (04:00 UTC)
const timerEndDate = new Date(Date.UTC(2023, 10, 1, 4)); // November 1 at 00:00 (04:00 UTC)
...
export const MakeupPromo20231023 = (): ReactElement => {
