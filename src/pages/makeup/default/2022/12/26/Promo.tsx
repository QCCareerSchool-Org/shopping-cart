...
export const MakeupPromo20221226 = (): ReactElement => {
    ...
    <>
      <section id="promoSection" style={{ backgroundColor, padding: 0 }}>
        ...
        <Modal size="lg" isOpen={popup} toggle={togglePopup}>
          ...
          <ModalBody>
            <p className="lead">Enroll in <strong>Master Makeup Artistry</strong> &amp; get the <strong>Global Beauty Workshop</strong> free.</p>
