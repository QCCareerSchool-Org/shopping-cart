  ...
  return (
    <header id="header">
      <div className="container py-3 py-sm-4">
        <div className="row">
          <div className="col-9 col-sm-12 text-left text-sm-center"><a href="https://www.qcmakeupacademy.com/"><img id="logo" src={require('./logo.svg')} width="455" height="49" alt="QC Makeup Academy" /></a></div>
