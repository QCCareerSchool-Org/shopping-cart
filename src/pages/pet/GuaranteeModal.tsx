...
export const GuaranteeModal: React.FC<Props> = ({ isOpen, toggle }) => (
  <Modal size="lg" isOpen={isOpen} toggle={toggle}>
    <ModalHeader toggle={toggle}>Refund policy: Your Dual Money-Back Guarantee</ModalHeader>
    <ModalBody>
      <div className="row">
        <div className="col-12 col-lg-4 d-none d-sm-block text-center">
          <img className="img-fluid mb-2" src={require('./guarantee-21-days.svg')} alt="21-Day Money-Back Guarantee" />
        </div>
        ...
        <div className="col-12 col-lg-4 d-none d-sm-block text-center">
          <img className="img-fluid mb-2" src={require('./guarantee-1-year.svg')} alt="1-Year Money-Back Guarantee" />
        </div>
        <div className="col-12 col-lg-8 text-left text-sm-center text-md-left">
