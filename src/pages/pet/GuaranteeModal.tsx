    ...
    <ModalBody>
      <div className="row">
        <div className="col-4 d-none d-sm-block text-center">
          <img className="img-fluid my-4" src={require('./21-Day-Money-Back-Guarantee-outlined.svg')} alt="The 21-Day Money Back Guarantee" />
          <img className="img-fluid my-4" src={require('./1-Year-Money-back-outlined.svg')} alt="1-Year Money Back Guarantee" />
        </div>
        <div className="col-12 col-sm-8">
          ...
          <p>If you have not earned the equivalent of your full tuition in dog grooming fees—either by freelancing or working for an established grooming company—within the first year after graduation, you’ll receive a full refund of your tuition.</p>
