...
export const PetPromo20230824: FC = () => {
    ...
    <>
      <section id="promoSection" style={{ backgroundColor, padding: 0 }}>
        ...
        <Modal size="md" isOpen={popup} toggle={togglePopup}>
          ...
          <ModalBody>
            <p className="lead mb-0">Enroll in any course and get {promoDiscount} off your tuition! You can get started today for only {getStarted}!</p>
          </ModalBody>
        </Modal>
      </section>
