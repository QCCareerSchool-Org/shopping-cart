...
export const PetPromo20221013: FC = () => {
    ...
    <>
      <section id="promoSection" style={{ backgroundColor: '#4ec8df', padding: 0 }}>
        ...
        <Modal size="md" isOpen={popup} toggle={togglePopup}>
          ...
          <ModalBody>
            <p className="lead">Enroll in QC&apos;s Dog Training or Dog Grooming certification course and save {price?.currency.code === 'GBP' ? '£150' : '$200'} on your tuition. Don&apos;t miss out!</p>
          </ModalBody>
        </Modal>
      </section>
