...
export const PetPromo20221103: FC = () => {
  ...
  return (
    <>
      ...
      <CountDownTimerWrapper
        ...
        message={<span style={{ textTransform: 'uppercase' }}>This exclusive offer ends <strong className="endHighlight">ends {date.getTime() >= timerEndDate.getTime() - (1000 * 60 * 60 * 24) ? 'today' : 'soon'}</strong></span>}
      />
    </>
  );
};
