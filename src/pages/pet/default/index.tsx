...
const Pet20231116 = lazy(async () => import('./2023/11/16').then(m => ({ default: m.Pet20231116 })));
const Pet20231127 = lazy(async () => import('./2023/11/27').then(m => ({ default: m.Pet20231127 })));
