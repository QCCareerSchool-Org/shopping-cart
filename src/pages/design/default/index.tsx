...
const Design20231116 = lazy(async () => import('./2023/11/16').then(m => ({ default: m.Design20231116 })));
const Design20231127 = lazy(async () => import('./2023/11/27').then(m => ({ default: m.Design20231127 })));
