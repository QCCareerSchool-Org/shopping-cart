        ...
        <div className="row">
          <div className="col-12 col-md-6 mb-3 mb-md-0">
            <Card
              ...
              imgSrc={require('./MAY21-card.jpg').default}
          ...
          <div className="col-12 col-md-6">
            <Card
              ...
              imgSrc={price?.currency.code === 'GBP' ? require('./SPRING100-card-uk.jpg').default : require('./SPRING100-card.jpg').default}
    ...
    <div style={{ position: 'relative', width: 312, height: 414, margin }}>
      ...
      <div style={{ position: 'absolute', width: '100%', bottom: '1.5rem' }}>
        {price?.promoCode === code
          ? <img src={require('./choose-offer-btn-active.png').default} width="228" height="46" className="img-fluid" alt={`${code} Promo Code Applied`} />
          : <button onClick={onClick} className="btn btn-link p-0 border-0 btn-no-hover-shadow"><img src={require('./choose-offer-btn.png').default} width="228" height="46" className="img-fluid" alt={`Apply ${code} Promo Code`} /></button>
        }
      </div>
    </div>
  );
