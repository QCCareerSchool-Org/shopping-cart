...
export const DesignPromo20221226: FC = () => {
    ...
    <>
      <section id="promoSection" style={{ backgroundColor, padding: 0 }}>
        ...
        <Modal isOpen={popup} toggle={togglePopup}>
          ...
          <ModalBody>
            <p>Start your home design career!</p>
            <p>Enroll in any online design course and get a FREE second course of your choice.</p>
            <p>That&apos;s not all: when you enroll, we&apos;ll also give you {price?.currency.code === 'GBP' ? '£75' : '$100'} off your tuition!</p>
          </ModalBody>
        </Modal>
      </section>
