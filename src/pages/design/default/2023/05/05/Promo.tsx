...
const lastChanceDate = new Date(Date.UTC(2023, 4, 8, 4)); // May 8 at 00:00 (04:00 UTC)
const timerShowDate = new Date(Date.UTC(2023, 4, 8, 4)); // May 8 at 00:00 (04:00 UTC)
const timerEndDate = new Date(Date.UTC(2023, 4, 13, 4)); // May 13 at 00:00 (04:00 UTC)
...
export const DesignPromo20230505: FC = () => {
  ...
  const promoDiscount = price?.currency.code === 'GBP' ? '£100' : '$100';
    ...
    <>
      <section id="promoSection" style={{ backgroundColor, padding: 0 }}>
        ...
        <Modal isOpen={popup} toggle={togglePopup}>
          ...
          <ModalBody>
            <p className="lead">Get a FREE 2nd course + {promoDiscount} off your tuition!</p>
            <p>Enroll in any online design course and get your second course for free. PLUS, an additional {promoDiscount} off your tuition!</p>
          </ModalBody>
        </Modal>
      </section>
