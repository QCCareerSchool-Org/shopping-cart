...
export const Footer: React.FC<Props> = ({ countryCode }) => {
  ...
  const termsLink = gbpCountry(countryCode) ? 'https://www.qcdesignschool.com/terms-gb.html' : 'https://www.qcdesignschool.com/terms.html';

  return (
    <footer id="footer">
      <div className="container text-center text-md-left">
        <span className="footer-item small">&copy; {new Date().getFullYear()} QC Design School</span>
