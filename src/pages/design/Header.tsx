  ...
  return (
    <header id="header">
      <div className="container my-3 my-sm-4">
        <div className="row">
          <div className="col-9 col-sm-12 text-left text-sm-center"><a href="https://www.qcdesignschool.com/"><img id="logo" src={require('./logo.svg').default} width="378" height="30" alt="QC Design School" /></a></div>
