...
export const EventPromo20230505: FC = () => {
    ...
    <>
      <section id="promoSection" style={{ backgroundColor, padding: 0 }}>
        ...
        <Modal isOpen={popup} toggle={togglePopup}>
          <ModalHeader toggle={togglePopup}>Get 2 FREE Specialty Courses!</ModalHeader>
          <ModalBody>
            <p className="mb-0">Enroll in any foundation course and get 2 free specialty courses. You can get started today for only {getStarted}!</p>
          </ModalBody>
        </Modal>
      </section>
