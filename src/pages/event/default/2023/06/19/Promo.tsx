...
export const EventPromo20230619: FC = () => {
    ...
    <>
      <section id="promoSection" style={{ backgroundColor, padding: 0 }}>
        ...
        <Modal isOpen={popup} toggle={togglePopup}>
          ...
          <ModalBody>
            <p className="mb-0">Enroll in any foundation course and get a <strong>free specialty course</strong>. You can get started today for only {getStarted}!</p>
          </ModalBody>
        </Modal>
      </section>
