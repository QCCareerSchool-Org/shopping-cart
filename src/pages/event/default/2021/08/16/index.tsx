      ...
      <section id="promoSection" style={{ backgroundColor: '#060606', padding: 0 }}>
        ...
        <Modal size="lg" isOpen={popup} toggle={togglePopup}>
          ...
          <ModalBody className="text-center">
            <p>Enroll in QC&apos;s <strong>Event &amp; Wedding Planning</strong> course and get ANY specialty course FREE. You&apos;ll also receive the <strong>Back-to-School Kit</strong>. This kit includes an eco-friendly notebook and a QC tote bag! Kit is valued at $50.</p>
            <p>Just select the <strong>Event &amp; Wedding Planning</strong> course and use promo code <PromoCode>BACK2SCHOOL</PromoCode>.</p>
          </ModalBody>
        </Modal>
      </section>
