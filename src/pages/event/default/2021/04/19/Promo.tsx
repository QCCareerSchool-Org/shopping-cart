    ...
    <section id="promoSection" style={{ backgroundColor: '#6886a0', padding: 0 }}>
      ...
      <Modal size="lg" isOpen={popup} toggle={togglePopup}>
        ...
        <ModalBody className="text-center">
          <p>Enroll in QC&aspo;s Event &amp; Wedding Planning course&mdash;with our lowest deposit ever&mdash;and get both the Destination Wedding Planning and the Luxury Wedding Planning courses for FREE.</p>
        </ModalBody>
      </Modal>
    </section>
  );
