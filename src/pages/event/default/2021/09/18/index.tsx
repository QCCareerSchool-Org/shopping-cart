...
import couponButtonAppliedSrc from './coupon-btn-GIFTCODE-active.svg';
import couponButtonSrc from './coupon-btn-GIFTCODE.svg';
...
export const Promo20210918: React.FC<Props> = ({ date }) => {
  ...
  const buttonClick = (): void => {
    dispatch({ type: 'SET_PROMO_CODE', payload: 'GIFTCODE' });
  };

  return (
    <>
      <section id="promoSection" style={{ backgroundColor: '#00a996', padding: 0 }}>
        ...
        <Modal size="lg" isOpen={popup} toggle={togglePopup}>
          ...
          <ModalBody>
            ...
            <p>Enroll in any foundation course and use promo code <PromoCode>GIFTCODE</PromoCode> to get your second course FREE. Plus, you&apos;ll receive TWO exclusive gifts: the QC tote bag &amp; Eco-Friendly Planner!</p>
          </ModalBody>
        </Modal>
      </section>
      <div className="text-white" style={{ backgroundColor: '#00a996' }}>
        <div className="container py-3 d-flex justify-content-center">
          {price?.promoCode === 'GIFTCODE'
