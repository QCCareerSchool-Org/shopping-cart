    ...
    <Modal size="sm" isOpen={isOpen} toggle={toggle} unmountOnClose={false}>
      ...
      <ModalBody>
        <form id="payment-form" method="POST" onSubmit={submit}>
          ...
          <div className="row">
            <div className="col-12">
              <button className={`btn ${buttonDisabled ? 'btn-secondary' : 'btn-success'} btn-lg btn-block`} disabled={submitting || !status.panValid || !status.expValid || !status.cvvValid}>Enroll Now</button>
