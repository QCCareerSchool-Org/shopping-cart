...
export const getPromos = (now: Date, price: PriceState, school: School, student: boolean): Promo[] => {
  const promos: Promo[] = [
...

    {
      ...
      student: 'DENIED',
      code: 'WEDDING21',
      description: <>Enroll in the <strong>Master Makeup Artistry</strong> course and get 50% off the <strong>Hair Styling</strong> course, plus get a FREE a free five-piece bridal makeup kit and hair styling wand!</>,
      ...
      altText: '50% off the Hair Styling course, plus FREE 5-piece bridal makeup kit and hair styling wand',
