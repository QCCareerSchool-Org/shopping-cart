...
export const isPet = (domain: string): boolean => [ 'pet.localhost', 'enroll.qcpetstudies.com', 'enroll.doggroomingcourse.com', 'pet.enrolltest.qccareerschool.com' ].includes(domain);
